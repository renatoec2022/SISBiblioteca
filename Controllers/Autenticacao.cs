...
namespace Biblioteca.Controllers
{
    public class Autenticacao
    {
        ...
        public static bool veirifcaLoginSenha(string login, string senha, Controller controller)
        {
            using(BibliotecaContext bc = new BibliotecaContext())
            {
                
                veirifcaSeUsuarioAdminExiste(bc);
        ...
        public static void veirifcaSeUsuarioAdminExiste(BibliotecaContext bc)
        {
            IQueryable<Usuario> userEncontrado = bc.usuarios.Where(u => u.login == "admin");
            //Não existe Usuário Admin: Criar o usuario adminn padrão
        ...
        public static void veirifcaSeUsuarioEAdmin(Controller controller)
        { 
